...
const Footer = () => {
  return (
      <footer className='flex flex-col justify-center items-center gap-5 text-sm'>
        <div className="flex justify-between items-center gap-5 mb-4">
        <div className="social-button">
          <a
            href="https://www.instagram.com/sherif.emad_/"
            target="_blank"
        ...
        {/* github */}
        <div className="social-button">
          <a href='https://github.com/sherifemad10' target="_blank" rel="noopener noreferrer">
    ...
    <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
      ...
      >
        ...
        <div className="social-button cursor-pointer">
          <a
            href="https://www.linkedin.com/in/sherifemad/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="relative w-12 h-12 rounded-full group cursor-pointer">
        ...
        <div className='flex justify-start items-center gap-4 w-full'>
          <a href="/Sherif Emad_Front-End_CV.pdf" download className='px-4 py-2 bg-[#847a8649] rounded-md hover:scale-105 transition-transform duration-300 backdrop-blur-2xl font-bold border-2 border-[#ffffff2a] '>
          <LuDownload className='inline mb-1 mr-2'/>
          Download CV
          </a>
          <a href="https://wa.me/201210587417" className='px-4 py-2 bg-[#4ade80] text-[#000] font-bold rounded-md hover:scale-105 transition-transform duration-300'>
          <FaWhatsapp className='inline mb-1 mr-2'/>
          Contact Me</a>
        </div>
      </footer>
  )
